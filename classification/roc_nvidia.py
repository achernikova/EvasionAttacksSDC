...
from utilities import read_images_steering_directions, generate_data, softmax

IMAGE_FILE = 'straight_right_left.csv'
IMAGE_FOLDER = '/home/alesia/Documents/sdc/'

LABELS_FILE = 'res_attack_labels_nvidia_straight_right_left.txt'
PROBABILITIES_FILE = 'res_attack_probas_nvidia_straight_right_left.txt'
...
for  i in range(0, NUM_ATTACKS):
    ...
    print( probabilities_attack_array[i])
...
plt.savefig('nvidia_roc_srl_micro_final.png', dpi = 250)
